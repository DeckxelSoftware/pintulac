...
import com.ec.pintulac.repository.VwJDCreacionDireccionesEntrega;
...
public class CotroladorGeneral {
	...
	@Autowired
	VwJDCreacionDireccionesEntrega vwJDVentaLogisticaFacturacionRepository;
	...
	public ResponseEntity<?> vwVentasPos() {
		try {
			...
			List<VwJdeCreacionDireccionesEntrega> ventas = vwJDVentaLogisticaFacturacionRepository.findAll();
			List<String> listaDatos = new ArrayList<String>();
			if (!ventas.isEmpty()) {

				for (VwJdeCreacionDireccionesEntrega items : ventas) {
