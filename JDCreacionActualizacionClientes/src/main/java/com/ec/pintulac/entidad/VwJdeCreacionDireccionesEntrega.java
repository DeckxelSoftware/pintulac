...
public class VwJdeCreacionDireccionesEntrega {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeCreacionDireccionesEntrega() {
		super();
	}

	public VwJdeCreacionDireccionesEntrega(String factura, String dato_json) {
		super();
