...
@RestController
@RequestMapping("/api")
@Api(value = "Existencias Fisicas Resumido", tags = "")
...
//	}
	...
	@ApiOperation(tags = "codigos_categoria", value = "Este API le permite consultar la lista de valores de los campos de la creación de clientes asociados a códigos de categoría")
	public ResponseEntity<?> codigosCategoria(@RequestBody Object param) {
