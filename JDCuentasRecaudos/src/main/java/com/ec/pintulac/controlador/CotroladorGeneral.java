...
//
//	}
	@PostMapping(value = "/cuentas_recaudos")
	@ApiOperation(tags = "Cuentas Recaudos", value = "Detallar las integraciones que componen la consulta de cuentas de recaudos.")
...
//			for (Row item : JSONJDE.getConnectorRequest1().getRows()) {
			...
			respuesta = generico.callStoreProcedureArray("DINAMIC.sp_jsonin_out_cuentas_recaudo", JSON);
