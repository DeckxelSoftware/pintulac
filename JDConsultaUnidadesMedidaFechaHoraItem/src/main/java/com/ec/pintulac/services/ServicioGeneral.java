...
public class ServicioGeneral {
	...
	public ConsultaUnidadesMedidaFechaHoraItemResponse invocarJDE(ConsultaUnidadesMedidaFechaHoraItemRequest param) {
		try {
			...
			HttpEntity<ConsultaUnidadesMedidaFechaHoraItemRequest> requestEntity = new HttpEntity<>(param, headers);
			...
			if (statusCode.is2xxSuccessful()) {
				ConsultaUnidadesMedidaFechaHoraItemResponse consultasCostosResponse = response.getBody();
