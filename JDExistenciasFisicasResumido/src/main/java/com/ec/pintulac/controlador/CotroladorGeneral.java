...
//
//	}
	@PostMapping(value = "/existencia_fisica_resumido")
	@ApiOperation(tags = " Existencias Fisicas Resumido", value = "Detallar las integraciones que componen la interfaz de salida para paso de existencias físicas resumido")
