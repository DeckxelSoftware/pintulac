...
@RestController
@RequestMapping("/api")
@Api(value = "Consumo Existencia fisica resumida", tags = "Existencia fisica resumida")
...
//	}
	...
	@PostMapping(value = "/existencia_fisica_resumida")
	@ApiOperation(tags = "Existencia fisica resumida", value = "Detallar las integraciones que componen la interfaz de salida para paso de existencias físicas resumido.")
