...
public class VwJdeJDGestionCargasCreacionCargas {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeJDGestionCargasCreacionCargas() {
		super();
	}

	public VwJdeJDGestionCargasCreacionCargas(String factura, String dato_json) {
		super();
