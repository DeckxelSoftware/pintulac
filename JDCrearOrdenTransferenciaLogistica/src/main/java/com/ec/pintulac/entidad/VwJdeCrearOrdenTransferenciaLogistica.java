...
public class VwJdeCrearOrdenTransferenciaLogistica {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeCrearOrdenTransferenciaLogistica() {
		super();
	}

	public VwJdeCrearOrdenTransferenciaLogistica(String factura, String dato_json) {
		super();
