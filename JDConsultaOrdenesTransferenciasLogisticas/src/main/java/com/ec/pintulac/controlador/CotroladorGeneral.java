...
//
//	}
	@PostMapping(value = "/ordenes_tranferencia_logistica")
	@ApiOperation(tags = "ordenes_tranferencia_logistica", value = "Detallar los elementos que conforman la integración de salida desde JDE para la consulta de órdenes de transferencias logísticas registradas, para integrar la información con el sistema satélite")
