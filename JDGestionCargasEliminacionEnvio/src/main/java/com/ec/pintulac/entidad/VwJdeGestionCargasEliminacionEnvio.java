...
public class VwJdeGestionCargasEliminacionEnvio {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeGestionCargasEliminacionEnvio() {
		super();
	}

	public VwJdeGestionCargasEliminacionEnvio(String factura, String dato_json) {
		super();
