...
public class VwJdeTransferenciaInternaInventarios {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeTransferenciaInternaInventarios() {
		super();
	}

	public VwJdeTransferenciaInternaInventarios(String factura, String dato_json) {
		super();
