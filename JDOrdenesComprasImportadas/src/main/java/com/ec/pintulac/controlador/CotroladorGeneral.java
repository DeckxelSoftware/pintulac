...
//
//	}
	@PostMapping(value = "/ordenes_compras_importadas")
	@ApiOperation(tags = "ordenes_compras_importadas", value = "Detallar los elementos que conforman la integración de salida desde JDE para la consulta de órdenes de compras importadas (OI) registradas, para integrar la información con el sistema satélite.")
