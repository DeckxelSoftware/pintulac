...
import com.ec.pintulac.repository.VwJDRecaudosRepository;
...
public class CotroladorGeneral {
	...
	@Autowired
	VwJDRecaudosRepository vwJDVentaLogisticaFacturacionRepository;
	...
	public ResponseEntity<?> vwVentasPos() {
		try {
			...
			List<VwJdeJDRecaudos> ventas = vwJDVentaLogisticaFacturacionRepository.findAll();
			List<String> listaDatos = new ArrayList<String>();
			if (!ventas.isEmpty()) {

				for (VwJdeJDRecaudos items : ventas) {
