...
//
//	}
	@PostMapping(value = "/reclasificacion_inventarios_jde")
	@ApiOperation(tags = "reclasificacion_inventarios_jde", value = "Detallar los elementos que conforman la integración de salida desde JDE para la consulta de reclasificaciones de inventarios, para integrar la información con el sistema satélite. ")
