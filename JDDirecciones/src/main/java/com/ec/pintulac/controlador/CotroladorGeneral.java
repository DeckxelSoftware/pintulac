...
import com.ec.pintulac.modelo.PrProv;
...
//	
	...
	@RequestMapping(value = "/pais_jde", method = RequestMethod.POST)
	@ApiOperation(tags = "Direccion", value = "Registrar o actulizar pais")
	public ResponseEntity<?> pais(@RequestBody PrProv param) {
...
//			
	...
	@RequestMapping(value = "/provincia_jde", method = RequestMethod.POST)
	@ApiOperation(tags = "Direccion", value = "Registrar o actulizar provincia")
	public ResponseEntity<?> provincia(@RequestBody PrProv param) {
...
//			
	...
	@RequestMapping(value = "/canton_jde", method = RequestMethod.POST)
	@ApiOperation(tags = "Direccion", value = "Registrar o actulizar canton")
	public ResponseEntity<?> canton(@RequestBody PrProv param) {
