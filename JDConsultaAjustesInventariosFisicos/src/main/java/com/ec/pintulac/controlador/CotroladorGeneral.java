...
//
//	}
	@PostMapping(value = "/consulta_ajustes_inventarios_fisicos")
	@ApiOperation(tags = "Consulta Ajustes Inventarios Fisicos", value = "Detallar los elementos que conforman la integración de salida desde JDE para la consulta de ajustes por inventarios físicos, para integrar la información con el sistema satélite. ")
