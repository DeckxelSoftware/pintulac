...
public class VwJdeGeneracionOrdenDevolucionCompras {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeGeneracionOrdenDevolucionCompras() {
		super();
	}

	public VwJdeGeneracionOrdenDevolucionCompras(String factura, String dato_json) {
		super();
