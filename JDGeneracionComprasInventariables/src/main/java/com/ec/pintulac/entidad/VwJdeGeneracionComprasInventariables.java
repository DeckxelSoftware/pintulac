...
public class VwJdeGeneracionComprasInventariables {
	@Id
	@Column(name = "FACTURA")
	...
	public VwJdeGeneracionComprasInventariables() {
		super();
	}

	public VwJdeGeneracionComprasInventariables(String factura, String dato_json) {
		super();
